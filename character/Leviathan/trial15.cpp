...
// Add this at the beginning of your main loop
...
int main() {
    ...
    // Read vertices and indices from Leviathan.obj
    std::ifstream objFile("Leviathan.obj");
    if (!objFile.is_open()) {
        std::cerr << "Failed to open Leviathan.obj" << std::endl;
        return -1;
    }
